...
func (m *UserMutation) SetAttributes(e enthstore.Hstore) {
	m.attributes = &e
}

// Attributes returns the value of the "attributes" field in the mutation.
func (m *UserMutation) Attributes() (r enthstore.Hstore, exists bool) {
	v := m.attributes
	if v == nil {
		return
	}
...
func (m *UserMutation) OldAttributes(ctx context.Context) (v enthstore.Hstore, err error) {
